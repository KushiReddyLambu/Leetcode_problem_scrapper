...
def problem_link(num):
    with open('Qdata/Qindex.txt', 'r', encoding='ISO-8859-1') as f:
        links = f.readlines()
    return links[num]


def problem_title(num):
    with open('Qdata/index.txt', 'r', encoding='ISO-8859-1') as f:
...
def load_vocab():
    ...
    with open('idf-values.txt', 'r', encoding='ISO-8859-1') as f:
...
def load_documents():
    documents = []
    with open('documents.txt', 'r', encoding='ISO-8859-1') as f:
...
def load_inverted_index():
    inverted_index = {}
    with open('inverted-index.txt', 'r', encoding='ISO-8859-1') as f:
